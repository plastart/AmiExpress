...
clean:
				delete expversion.e acpversion.e
				delete express verinfogen express5 acp qwk ftn jsonimport icon2cfg miscfuncs.m stringlist.m errors.m mailssl.m jsoncreate.m jsonparser.m axcommon.m ftpd.m httpd.m axconsts.m axobjects.m axenums.m zmodem.m bcd.m expversion.m acpversion.m pwdhash.m tooltypes.m

install:
				copy express5 BBS:express5
				copy acp BBS:acp
				copy jsonimport BBS:Utils/jsonimport
				copy icon2cfg BBS:Utils/icon2cfg
				copy qwk BBS:Utils/qwk
				copy ftn BBS:Utils/ftn
